            ...
            if (this.options.values && this.options.values.length) {
                ...
                if (slideDist != 0) {
                    ...
                    if (allowed !== false) {
                        ...
                        $(this.handles[0]).attr('title', sliderData[newValueLeft]).tooltip('fixTitle').tooltip('show');                       
                        $(this.handles[1]).attr('title', sliderData[newValueRight]).tooltip('fixTitle').tooltip('show');                        
                    }
                    this._rangeStart = newVal;
                }
            }
